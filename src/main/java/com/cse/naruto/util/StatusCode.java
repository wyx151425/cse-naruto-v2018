...
public class StatusCode {
    ...
    public static final int USER_LOGIN_PASSWORD_ERROR = 1002;
    ...
    public static final int MATERIAL_NOT_EXIST = 1200;
    public static final int MATERIAL_LEVEL_BLANK = 1201;
    public static final int USER_REGISTERED = 10000;
}
